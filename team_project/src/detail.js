...
const playMovieTrailer = async () => {
  ...
  const findTrailerVideo = videos.results.find((video) => video.type === "Trailer");
...
const showMovieDetails = async () => {
  ...
  const currentMoviePoster = detailsContainer.querySelector("#current-movie-poster");
  const currentMovieTitle = detailsContainer.querySelector("#current-movie-title");
  const currentMovieGenre = detailsContainer.querySelector("#current-movie-genre");
  ...
  const currentMovieOverView = detailsContainer.querySelector('#current-movie-overview')
